# Ayurveda Web Application

A web-based platform built with JavaScript, HTML, and CSS, deployed on Vercel.

Live Demo: [ayurveda-t18n.vercel.app](https://ayurveda-t18n.vercel.app/)
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/abheeshtaadhikari-source/ayurveda.git](https://github.com/abheeshtaadhikari-source/ayurveda.git)
   cd ayurveda
